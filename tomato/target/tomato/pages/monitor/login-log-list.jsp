                ...
                <div class="panel panel-default">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${pageInfo.list}" var="log" varStatus="status">
                                    <tr>
                                        <td>${status.index}</td>
                                        <td>${log.loginUsername}</td>
                                        <td>${log.loginTime}</td>
                                        <td>${log.loginAddr}</td>
                                        <td>${log.loginSystem}</td>
                                        <td>${log.loginBrowser}</td>
                                        <td>其他</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                    ...
                    <nav aria-label="Page navigation" style="text-align: center">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/monitor/logininfor.do?page=1">首页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/monitor/logininfor.do?page=${pageInfo.prePage}" aria-label="Previous">
                                    </c:if>
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="num" >
                                ...
                                <c:if test="${num != pageInfo.pageNum}" >
                                    <li><a href="${pageContext.request.contextPath}/monitor/logininfor.do?page=${num}">${num}</a></li>
                                </c:if>
                           ...
                           <c:if test="${pageInfo.pageNum<=pageInfo.pages-1}">
                            ...
                            <li>   <a href="${pageContext.request.contextPath}/monitor/logininfor.do?page=${pageInfo.pageNum+1}" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a></li>
                            <li><a href="${pageContext.request.contextPath}/monitor/logininfor.do?page=${pageInfo.pages}">尾页</a>
                                </c:if>
